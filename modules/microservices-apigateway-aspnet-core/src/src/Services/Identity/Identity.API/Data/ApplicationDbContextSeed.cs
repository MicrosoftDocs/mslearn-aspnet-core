...
namespace Microsoft.eShopOnContainers.Services.Identity.API.Data
{
    ...
    public class ApplicationDbContextSeed
    {
        ...
        private IEnumerable<ApplicationUser> GetDefaultUser()
        {
            ...
            {
                CardHolderName = "AdminUser",
                CardNumber = "4012888888881881",
                CardType = 1,
                City = "Redmond",
                Country = "U.S.",
                Email = "adminuser@microsoft.com",
                Expiration = "12/30",
                Id = Guid.NewGuid().ToString(),
                ...
                Street = "15703 NE 61st Ct",
                SecurityNumber = "535",
                NormalizedEmail = "ADMINUSER@MICROSOFT.COM",
                NormalizedUserName = "ADMINUSER@MICROSOFT.COM",
                SecurityStamp = Guid.NewGuid().ToString("D"),
            };            

            adminUser.PasswordHash = _passwordHasher.HashPassword(adminUser, "Pass@word1");
